            ...
            if (errorViewResId != -1) {
                ...
                if (errorViewResId == R.layout.layout_error) {
                    ...
                    this.textOfErrorView =
                        a.getString(R.styleable.BaseView_textOfErrorView) ?: "here is error view."
                    this.buttonTextOfErrorView =
                        a.getString(R.styleable.BaseView_buttonTextOfErrorView) ?: "Retry"
